...
const QuizSection = () => {
    return (
        <div className="bg-slate-200 h-full p-2 sm:p-20">
            <div className="w-5/6 mx-auto grid py-20 px-5 lg:grid-cols-4 gap-x-2 gap-y-8 sm:gap-2 h-full">
                <div style={{ color: '#3B058E' }} className="flex justify-center items-start flex-col">
                    ...
                    <p className="text-lg pt-3 flex items-center">Learn how it works &nbsp; <FaArrowRight style={{fontSize: '14px', marginTop: '3px' }} /></p>
                </div>
