    ...
    return (
        <div className='grid grid-cols-3 my-5 py-5 mx-5 bg-slate-100 rounded-md'>
            ...
            <div className='flex-auto md:space-x-10 my-2'>
                <h1 className='inline-flex font-semibold text-slate-700 mr-5'> <span className='my-auto mr-1'><BsFillClockFill/></span> {moment(date).fromNow()}</h1>
            ...
            <Link href={`forum/${no}`}>
                <button className='rounded-3xl bg-yellow-500 text-white font-semibold p-2 px-10 hover:bg-slate-700 duration-300 inline-flex px-4'>
                    Read More 
                </button>
            </Link>
            </div>
