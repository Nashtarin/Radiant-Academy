                    ...
                    <div className="hidden ps-2 mx-2 sm:mx-0 lg:flex pr-10">
                        <div className="flex items-center">
                            ...
                            <Link passHref href="/register">
                                <button className="btn border-0 px-7 py-2 rounded bg-rose-500 text-white transition duration-500 ms-3">FREE TRIAL</button>
                            </Link>
                        </div>
                    </div>
                    <div className="flex-none dropdown dropdown-left my-auto pr-2 sm:mr-3 lg:mr-12">
