...
import { BsFillClockFill, BsArrowRight } from "react-icons/bs";
...
const BlogCard = ({ blog }) => {
    ...
    return (
        <div className="grid grid-rows-1 my-5 mx-5 bg-slate-100 rounded-md shadow-md">
            <div className="px-4 sm:px-8">
                <h1 className="text-2xl font-bold text-violet-800 mt-5 mb-1">
                    {title}
                </h1>
