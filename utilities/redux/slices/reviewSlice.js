...
export const fetchReviews = createAsyncThunk(
    'review/fetchReviews',
    async () => {
        const response = await fetch('https://radiant-academy-vert.vercel.app/api/reviews')
            .then(res => res.json())
...
export const addReview = createAsyncThunk(
    ...
    async (review) => {
        try {
            const response = await axios.post("https://radiant-academy-vert.vercel.app/api/reviews", review);
