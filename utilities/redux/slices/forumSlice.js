...
export const fetchForums = createAsyncThunk(
    'forum/fetchForums',
    async () => {
        const response = await fetch('https://radiant-academy-vert.vercel.app/api/forums')
            .then(res => res.json())
...
export const topicCreate = createAsyncThunk(
    ...
    async (forum) => {
        try {
            const response = await axios.post("https://radiant-academy-vert.vercel.app/api/forums", forum);
...
export const topicView = createAsyncThunk(
    ...
    async (forum) => {
        try {
            const response = await axios.put(`https://radiant-academy-vert.vercel.app/api/forums/views/${forum._id}`);
            return response.data
        } catch (error) {
            console.log(error);
        }
...
export const topicReact = createAsyncThunk(
    ...
    async (forum) => {
        try {
            const response = await axios.put(`https://radiant-academy-vert.vercel.app/api/forums/reacts/${forum._id}`);
            return response.data
        } catch (error) {
            console.log(error);
        }
...
export const approveTopic = createAsyncThunk(
    ...
    async (id) => {
        try {
            const response = await axios.put(`https://radiant-academy-vert.vercel.app/api/forums/approve/${id}`);
            return response.data
        } catch (error) {
            console.log(error);
        }
...
export const deleteTopic = createAsyncThunk(
    'forum/deleteTopic',
    async (id) => {
        const response = await axios.delete(`https://radiant-academy-vert.vercel.app/api/forums/${id}`, id);
        return response.data
    }
)
...
export const updateTopic = createAsyncThunk(
    ...
    async (forum) => {
        try {
            const response = await axios.put(`https://radiant-academy-vert.vercel.app/api/forums/edit/${forum._id}`, forum);
            return forum
        } catch (error) {
            console.log(error);
        }
