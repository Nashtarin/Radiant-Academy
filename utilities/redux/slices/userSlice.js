...
export const fetchUsers = createAsyncThunk(
    'user/fetchUsers',
    async () => {
        const response = await fetch('https://radiant-academy-vert.vercel.app/api/users')
            .then(res => res.json())
...
export const deleteUser = createAsyncThunk(
    'user/deleteUser',
    async (id) => {
        const response = await axios.delete(`https://radiant-academy-vert.vercel.app/api/users/${id}`, id);
        return response.data
    }
)
...
export const makeAdmin = createAsyncThunk(
    ...
    async (id) => {
        try {
            const response = await axios.put(`https://radiant-academy-vert.vercel.app/api/users/roles/admin/${id}`);
            return response.data
        } catch (error) {
            console.log(error);
        }
...
export const removeAdmin = createAsyncThunk(
    ...
    async (id) => {
        try {
            const response = await axios.put(`https://radiant-academy-vert.vercel.app/api/users/roles/user/${id}`);
            return response.data
        } catch (error) {
            console.log(error);
        }
